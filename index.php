...
<html lang="en">
  <head>
	...
	<link rel="icon" href="assets/images/logo-ubg.png" type="image/ico" />

    <title> Komunitas Desain Grafis </title>
      ...
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            ...
            <center>
            &nbsp; <a href="index.php" class=" " style="color:#fff;"><span><font size="4.95" color="white" face="Helvetica Neue">KOMUNITAS DESAIN GRAFIS</font></span></a>
            </center>
            </div>
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                <img src="assets/images/IMG_20200211_120234.jpg" alt="..." class="img-circle profile_img">
              </div>
              <div class="profile_info">
                <span>Welcome,</span>
                <h2>Mauiza Afriliani</h2>
              </div>
            </div>
            <!-- /menu profile quick info -->
              ...
              <div class="menu_section">
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-desktop"></i> Kategori <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="#">Tampil Kategori</a></li>
              ...
              <ul class=" navbar-right">
                <li class="nav-item dropdown open" >
                  <a href="#" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
                    <img src="assets/images/login.png" alt="">Mauiza Afriliani
                  </a>
